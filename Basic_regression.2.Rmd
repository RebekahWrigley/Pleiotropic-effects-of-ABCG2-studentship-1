...
if you want to look at the coefficients and confidence intervals of all regression models.
...
```
  ...
  results$CI_1[]<- cf[2,1]
  results$CI_2[]<- cf[2,2]
  results$n[]<-  (summary(fit)$df[2]) + 1 # number (in this case "5") should be number of explanatory variables + 1
