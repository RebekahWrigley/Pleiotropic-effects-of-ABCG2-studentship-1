...
Code imports all .txt files from the working directory, credit to Tom Kelly for showing me this. (I didn't do this but wish I had.)
```{R, eval=FALSE}
setwd("Imputed_data/")  # Change directory to where the correct files are.
